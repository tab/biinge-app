export const TMDB_PERSON_MOVIE_CREDITS = {
  id: 933238,
  cast: [
    {
      adult: false,
...
export const TMDB_PERSON_TV_CREDITS = {
  id: 933238,
  cast: [],
  crew: [],
}

export const TMDB_PERSON_DETAILS = {
  adult: false,
  also_known_as: [
  ...
  credits: TMDB_PERSON_MOVIE_CREDITS,
  tv_credits: TMDB_PERSON_TV_CREDITS,
}
...
export const PERSON_TV_CREDITS = []
